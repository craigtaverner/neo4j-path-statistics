...
//        }
    ...
    public void testCountPathsDepthTwo() {
        long maxDepth = 2;
        testCallCount(db, "CALL labelpath.stats(" + maxDepth + ")", null, 43);
        testResult(db, "CALL labelpath.stats(" + maxDepth + ")", result ->
        {
...
//                assertThat(count, greaterThan(0L));
    ...
    public void testCountPathsDefaultDepth() {
        testCallCount(db, "CALL labelpath.stats", null, 259);
    }
}
